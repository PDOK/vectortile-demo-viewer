...
export const environment = {
  ...
  DKKstandaard:'https://api.pdok.nl/kadaster/kadastralekaart/ogc/v1/styles/standaardvisualisatie__netherlandsrdnewquad',
  DKKkwaliteit: 'https://api.pdok.nl/kadaster/kadastralekaart/ogc/v1es/kwaliteitsvisualisatie__netherlandsrdnewquad',
